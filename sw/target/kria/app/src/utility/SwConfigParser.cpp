...
SwConfigParser::SwConfigParser(std::string fpath_cfg){
    ...
    r = !extract_json_variable(config_json, "genoa_pulse_width_us",          _config.genoa_pulse_width_us);
    r = !extract_json_variable(config_json, "genoa_single_neuron_id",        _config.genoa_single_neuron_id);
    r = !extract_json_variable(config_json, "genoa_network_burst_threshold", _config.genoa_network_burst_threshold);
    r = !extract_json_variable(config_json, "genoa_network_burst_window",    _config.genoa_network_burst_window);
    r = !extract_json_variable(config_json, "genoa_group_burst_threshold",   _config.genoa_group_burst_threshold);
    r = !extract_json_variable(config_json, "genoa_group_burst_window",      _config.genoa_group_burst_window);
    r = !extract_json_variable(config_json, "genoa_group_neuron_id",         _config.genoa_group_neuron_id);

    for (int i = 0; i < _config.genoa_group_neuron_id.size(); i++)
        _config.genoa_group_neuron_id_tab[i] = _config.genoa_group_neuron_id[i];
}
...
void SwConfigParser::print(){
    ...
    print("genoa_pulse_width_us",          _config.genoa_pulse_width_us);
    print("genoa_single_neuron_id",        _config.genoa_single_neuron_id);
    print("genoa_network_burst_threshold", _config.genoa_network_burst_threshold);
    print("genoa_network_burst_window",    _config.genoa_network_burst_window);
    print("genoa_group_burst_threshold",   _config.genoa_group_burst_threshold);
    print("genoa_group_burst_window",      _config.genoa_group_burst_window);
    print("genoa_group_neuron_id",         _config.genoa_group_neuron_id);
}
...
void SwConfigParser::print(std::string key, double value){
    std::cout << key << ": " << value << std::endl;
}

void SwConfigParser::print(std::string key, uint32_t value){
    std::cout << key << ": " << value << std::endl;
}
